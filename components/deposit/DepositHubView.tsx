...
const METHODS = [
  {
    ...
    badge: "On-chain",
    badgeClass:
      "border-[#D4AF37]/30 bg-[#D4AF37]/10 text-[#F5E6B3]",
    icon: Wallet,
    ...
    description: "Send BTC, ETH, USDT, and more from your wallet. Select coin, network, and amount.",
  },
  {
    href: "/p2p/buy",
    ...
    description:
      "Buy from verified merchants via bank transfer, M-Pesa, and 350+ payment options.",
  },
] as const;
      ...
      <div className="relative mx-auto w-full max-w-4xl px-4 py-5 sm:px-6 sm:py-8">
        ...
        <header className="mt-4 max-w-xl">
          ...
          <h1 className="mt-2 text-xl font-semibold tracking-tight text-white sm:text-2xl">
            Deposit <span className="gold-gradient">funds</span>
          </h1>
          <p className="mt-1.5 text-xs leading-relaxed text-zinc-500 sm:text-sm">
            Choose how you want to add capital. On-chain deposits are reviewed before your balance
            is credited.
          </p>
        </header>
