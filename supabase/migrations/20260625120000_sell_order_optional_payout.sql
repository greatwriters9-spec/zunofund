-- Investors may share payout coordinates in trade chat after opening the ticket.
...
COMMENT ON FUNCTION public.investor_create_merchant_sell_order(uuid, numeric, text, text) IS
  'Investor sells USDT; payout instructions optional at open — may be sent in trade chat.';
