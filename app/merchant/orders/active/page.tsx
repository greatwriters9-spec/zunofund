...
export default function MerchantActiveTradesPage() {
    ...
    <main className="min-h-screen bg-zinc-950 p-6 text-white">
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-yellow-500">Active trades</h1>
            <p className="mt-2 max-w-xl text-sm text-zinc-500">
              Waiting for payment, in progress, or awaiting release. Matches how investors see trades in
              chronological order — open date, counterpart, status, amount.
            </p>
          </div>
          <Link
            href="/merchant"
        ...
        {loading ? (
          ...
          <div className="mt-6">
            <MerchantTradesList
              orders={orders}
              emptyMessage="No active trades. When buyers or sellers open trades against your offers, they will appear here."
            />
          </div>
        )}
      </div>
